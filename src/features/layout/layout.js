  ...
  return (
    <>
      ...
      <div className={classNames(styles.container)}>
        <Sidebar />
        <Switch>
          <ProtectedRoute roles={[2, 4, 8]} exact path={paths.STUDENTS} component={ListOfStudents} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={`${paths.STUDENTS_DETAILS}/:id`} component={() => <StudentsTabs index={0} />} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={`${paths.STUDENT_EDIT}/:id`} component={() => <StudentsTabs index={1} />} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={paths.MENTORS} component={ListOfMentors} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={`${paths.MENTORS_DETAILS}/:id`} render={() => <MentorTabs index={0} />} />
          <ProtectedRoute roles={[4, 8]} exact path={`${paths.MENTOR_EDIT}/:id`} render={() => <MentorTabs index={1} />} />
          <ProtectedRoute roles={[4, 8]} exact path={paths.SECRETARIES} component={ListOfSecretaries} />
          <ProtectedRoute roles={[4, 8]} exact path={`${paths.SECRETARIES_DETAILS}/:id`} render={() => <SecretariesTabs index={0} />} />
          <ProtectedRoute roles={[4]} exact path={`${paths.SECRETARY_EDIT}/:id`} render={() => <SecretariesTabs index={1} />} />
          <ProtectedRoute roles={[1, 2, 4, 8]} exact path={paths.LESSONS} render={lessonsListComponent} />
          <ProtectedRoute roles={[2, 4]} exact path={paths.LESSON_ADD} component={AddLesson} />
          <ProtectedRoute roles={[1, 2, 4, 8]} exact path={`${paths.LESSON_DETAILS}/:id`} render={lessonDetailsComponent} />
          <ProtectedRoute roles={[2, 4]} exact path={`${paths.LESSON_EDIT}/:id`} component={EditLesson} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={paths.GROUPS} component={ListOfGroups} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={paths.GROUP_ADD} component={StartGroup} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={`${paths.GROUPS_DETAILS}/:id`} render={() => <GroupsTabs index={0} />} />
          <ProtectedRoute roles={[2, 4, 8]} exact path={`${paths.GROUP_EDIT}/:id`} render={() => <GroupsTabs index={1} />} />
          <ProtectedRoute roles={[1, 2, 4, 8]} exact path={paths.COURSES} component={ListOfCourses} />
          ...
          <ProtectedRoute roles={[2, 4, 8]} exact path={paths.THEMES_DOWNLOAD} component={DownloadThemes} />
          <ProtectedRoute roles={[4, 8]} exact path={paths.STUDENTS_BY_GROUP_ID} component={DownloadStudents} />
          ...
          <ProtectedRoute roles={[1, 2, 4, 8]} exact path={paths.HOME} render={() => <Redirect to={homepages[currentUser.role]} />} />

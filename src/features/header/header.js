        ...
        <div className={styles.header__account} ref={wrapperRef}>
          ...
          >
            <span
              className={
                dropdown
                  ? styles['header__dropdown-icon-active']
                  : styles['header__dropdown-icon']
              }
            >
              &#9660;
            </span>
          ...
          <ul
            className={
              dropdown
                ? styles['header__dropdown-list-show']
                : styles['header__dropdown-list']
            }
          >
            <li
              className={styles['header__dropdown-list--item']}
              onClick={toggleDropdown}
            >
              <Link
                className={classNames(
                  'd-block w-100',
                  styles['header__account-user--icon']
                )}
                to={paths.MY_PROFILE}
              >
                My profile
